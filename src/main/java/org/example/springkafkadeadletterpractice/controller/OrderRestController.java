package org.example.springkafkadeadletterpractice.controller;
...
import org.example.springkafkadeadletterpractice.controller.rqrs.OrderCreateRq;
import org.example.springkafkadeadletterpractice.service.order.OrderService;
...
public class OrderRestController {
    ...
    public ResponseEntity<List<Long>> bulkCreate() throws InterruptedException {
        ...
        List<Long> result = Lists.newArrayList(createdOrderIds);
